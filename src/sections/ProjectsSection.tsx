...
const projects = [
  ...
  },
  {
    ...
    description: 'A beautiful task management application with drag-and-drop functionality and team collaboration.',
  ...
  },
  {
    ...
    description: 'An AI-powered application that generates high-quality content for blogs and marketing materials.',
